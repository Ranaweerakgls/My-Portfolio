  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center px-4 sm:px-6 md:px-12 lg:px-20 py-20 sm:py-24 md:py-32 overflow-hidden">
      ...
      >
        ...
        >
          <motion.div
            ...
            whileHover={{
              scale: 1.05,
              rotate: 1,
              boxShadow: "0 25px 60px rgba(244,114,182,0.25)",
            }}
          >
            <img
              src={imageSrc}
          ...
          <motion.div
            className="absolute -top-10 -left-10 hidden md:flex flex-col gap-4"
            variants={container}
            initial="hidden"
            animate="visible"
          >
          ...
          <motion.div
            className="absolute -bottom-6 -right-6 hidden md:flex flex-col gap-4"
            variants={container}
            initial="hidden"
            animate="visible"
          >
            <motion.div
              ...
              whileHover={{
                scale: 1.12,
                rotate: -5,
                boxShadow: "0 12px 30px rgba(168,85,247,0.5)",
              }}
            >
              UI/UX Designer
            </motion.div>
        ...
        {/* TEXT SECTION */}
        <motion.div
          className="flex flex-col items-start text-left space-y-4 sm:space-y-6 md:space-y-10 w-full sm:w-auto"
        >
          <motion.div variants={fadeUp(0)}>
            <motion.p
              className="text-base sm:text-lg md:text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-purple-400 to-indigo-400 leading-tight cursor-pointer"
              variants={fadeUp(0)}
              initial="hidden"
              animate="visible"
            ...
            <motion.h1
              className="text-3xl sm:text-4xl md:text-8xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-purple-400 to-indigo-400 leading-tight cursor-pointer"
              variants={fadeUp(0.1)}
              initial="hidden"
              animate="visible"
          ...
          <motion.div
            className="flex flex-col sm:flex-row gap-3 sm:gap-6 mt-2 w-full sm:w-auto"
            variants={fadeUp(0.5)}
            initial="hidden"
            animate="visible"
          >
